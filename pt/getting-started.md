...
No lado direito de qualquer página, você vai notar links para editar a página, ou
abrir um assunto. Isto assegura que a qualquer momento você tenha uma pergunta ou queira 
sugerir ou solicitar uma mudança, você pode fazer isso imediatamente e ligar diretamente
para a seção de interesse. As seções da página também têm ligações permanentes, portanto
você pode se conectar diretamente a eles.


### Busca

Todo o site, incluindo postagens e documentação, é indexado e depois disponível
para busca na parte superior ou lateral da página. Experimente! O conteúdo é apresentado
em dados de janela que são usados pelo lunr.js para gerar os resultados da busca.
Se você quiser excluir qualquer arquivo da busca, acrescente isto ao seu front end:
